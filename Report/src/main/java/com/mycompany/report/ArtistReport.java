...
public class ArtistReport {
    ...
    public ArtistReport(int id, String name, int totalQuanity, float totalPrice) {
        this.id = id;
        this.name = name;
    ...
    public ArtistReport(String name, int totalQuanity, float totalPrice) {
        this.id = -1;
        this.name = name;
        this.totalQuantity = totalQuanity;
        this.totalPrice = totalPrice;
    ...
    public String toString() {
        return "ArtistReport{" + "id: " + id + ", name: " + name + ", totalQuanity: " + totalQuantity + ", totalPrice: " + totalPrice + '}';
    }
